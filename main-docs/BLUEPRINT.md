...
## 1. Project Overview
"Solve Print" is a web-based platform designed to solve the excessive crowding at college printing shops. It streamlines the printing process through high automation, real-time tracking, and AI-driven document analysis.
...
- **Supabase PostgreSQL**:
    ...
    - `documents`: Stores file references and AI-inspected metadata.
...
- **AI File Inspector**: Using **Gemini 1.5 Flash** to automatically count pages and detect color/text balance. This prevents user errors.
...
- **Step-by-Step Flow**:
    ...
    2. AI provides price preview based on Owner's rates.
...
- **AI**: Google AI Studio (Gemini Free Tier for up to 15 requests/minute).
